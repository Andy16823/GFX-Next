...
namespace LibGFX.Core.GameElements
{
    public class Sprite : GameElement
    {
        ...
        public Sprite(Vector2 position, Vector2 scale, Texture texture)
        {
        ...
        public Sprite(Vector3 position, Vector3 scale, Texture texture)
        {
            this.Color = new Vector4(1, 1, 1, 1);
        ...
        public override void Render(BaseScene scene, Viewport viewport, IRenderDevice renderer, Camera camera)
        {
            ...
            if(this.Visible)
            {
                ...
                renderer.DrawTexture(Position, Rotation, Scale, Texture, Color);
